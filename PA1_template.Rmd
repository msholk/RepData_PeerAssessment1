...
```{r total_steps_per_day, fig.path='figure/'}
...
```{r average_steps_per_interval, fig.path='figure/'}
...
```
The total number of missing values __`r total_missing_values`__  
...
```{r total_steps_per_day_filled, fig.path='figure/'}
...
```{r combined_data, fig.path='figure/'}
...
```
```{r final_bar_plot, fig.path='figure/'}
